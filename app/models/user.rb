...
class User < ApplicationRecord
  ...
  #validates_with EmailMxValidator, if: :validate_email_dns? # Verismile removido função que valida o domínio do email. 2023/11/09
  ...
  # before_create :set_approved # verismile: removido 2023/11/9
  before_create :auto_confirm # verismile adicionado 2023/11/9
  ...
  # Verismile: source code Truthsocial
  def user_token
  ...
  # Verismile: adicionado 2023/11/09. Adiciona o usuário sem confirmação de e-mail
  def auto_confirm
